...
public final class NetworkingUtilities {
    ...
    /**
     * Create a private constructor because no one should ever create a {@link NetworkingUtilities} object.
     ...
     */
    public static ArrayList<Earthquake> convertJSONtoEarthquakes() {
